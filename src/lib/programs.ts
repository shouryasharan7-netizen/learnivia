...
export const PROGRAMS: Program[] = [
  {
    ...
    faq: [
      { question: "Do I need to book in advance?", answer: "Yes. You choose a tutor and book a time slot that works for both of you." },
      { question: "What if my tutor doesn't know my topic?", answer: "You can browse tutor profiles and filter by subject before booking." },
    ],
  },
  {
    ...
    faq: [
      { question: "Is this for struggling students only?", answer: "Not at all. Learners at any level use this to solidify understanding or get ahead." },
      { question: "What year levels are supported?", answer: "Primary through pre-university. Filter by grade level when searching for a tutor." },
    ],
  },
  {
    ...
    faq: [
      { question: "Can tutors help with lab reports?", answer: "Yes. Share your draft and a tutor can give written and verbal feedback." },
    ],
  },
  {
    slug: "exam-prep",
    ...
    subjects: ["All GCSE subjects", "A-Level / AP subjects", "School exam preparation"],
  ...
  },
  {
    ...
    faq: [
      { question: "Should I share my draft before the session?", answer: "It helps, but not required. Tutors can also help you start from scratch." },
    ],
  },
  {
    slug: "study-skills",
    ...
    subjects: ["Note-taking techniques", "Time management", "Revision planning", "Focus & procrastination"],
    gradeLevels: ["Lower Secondary", "GCSE / O-Level", "A-Level / AP", "University"],
    format: "One-on-one via Zoom",
    duration: "45 minutes",
    outcomes: [
