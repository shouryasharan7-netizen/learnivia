...
const getInvolvedLinks = [
  {
    href: "/apply",
    label: "Become a Volunteer Tutor",
    desc: "Share your knowledge and earn verified hours",
  },
  {
    href: "/how-it-works",
    label: "How It Works",
  ...
  },
  {
    href: "/educators",
    label: "For Educators",
    desc: "Bring Learnivia to your classroom",
  },
];
...
export function Navbar() {
  ...
  const [activePopover, setActivePopover] = useState<
    "messages" | "notifications" | "calendar" | "user" | null
  >(null);
          ...
          <div className={styles.authActions} ref={popoverRef}>
            ...
            <div className={styles.actionWrapper}>
              <button
                ...
                onClick={() =>
                  setActivePopover(
                    activePopover === "messages" ? null : "messages",
                  )
                }
              >
                <svg
                ...
                >
                  ...
                  <div className={styles.popoverEmpty}>
                    ...
                    <p className={styles.popoverEmptyText}>
                      When you connect with tutors or attend group sessions,
            ...
            <div className={styles.actionWrapper}>
              <button
                ...
                onClick={() =>
                  setActivePopover(
                    activePopover === "notifications" ? null : "notifications",
                  )
                }
              >
                <svg
              ...
              {activePopover === "notifications" && (
                ...
                >
                  ...
                  <div className={styles.popoverEmpty}>
                    ...
                    <p className={styles.popoverEmptyTitle}>
                      You&apos;re all caught up!
                    </p>
                    <p className={styles.popoverEmptyText}>
                      Session reminders, enrollment confirmations, and community
            ...
            <div className={styles.actionWrapper}>
              <button
                ...
                onClick={() =>
                  setActivePopover(
                    activePopover === "calendar" ? null : "calendar",
                  )
                }
              >
                <svg
              ...
              {activePopover === "calendar" && (
                ...
                >
                  ...
                  <div className={styles.popoverEmpty}>
                    ...
                    <p className={styles.popoverEmptyText}>
                      Check your upcoming bookings or register for a live study
                      session.
                    </p>
                  </div>
                  <Link
            ...
            <div className={styles.actionWrapper}>
              ...
              {activePopover === "user" && (
                <div
                  className={`${styles.popoverMenu} ${styles.userProfileMenu}`}
                  role="menu"
                >
                  ...
                  <div className={styles.userMenuList}>
                    ...
                    {isAdmin && (
                      <Link
                        ...
                        onClick={() => setActivePopover(null)}
                        style={{
                          color: "var(--wa-warning, #D97706)",
                          fontWeight: 700,
                          background: "var(--wa-warning-bg, #FFFBEB)",
                        }}
                      >
                        <ShieldAlert
                          size={16}
    ...
    <>
      ...
      >
        <span style={{ opacity: 0.85 }}>
          Non-Profit · Supervised 1-on-1 tutoring for Kindergarten to Grade 10 ·
          100% Free
        </span>
        <span
          style={{
      ...
      <header className={styles.header} role="banner">
        <div className={styles.container}>
          ...
          <nav className={styles.nav} aria-label="Main navigation">
            ...
            <div className={styles.dropdownWrapper} ref={exploreRef}>
              ...
              >
                ...
                <span
                  className={`${styles.chevron} ${exploreOpen ? styles.chevronOpen : ""}`}
                  aria-hidden="true"
                >
                  {exploreOpen ? "▲" : "▼"}
                </span>
                    ...
                    {megaMenuPrograms.map((prog) => (
                      ...
                      >
                        <div className={styles.megaCardTop}>
                          ...
                          <span className={styles.megaCardBadge}>
                            {prog.badge}
                          </span>
                        </div>
          ...
          >
            <span
              className={`${styles.hamburgerLine} ${mobileOpen ? styles.hamburgerLineOpen1 : ""}`}
            />
            <span
              className={`${styles.hamburgerLine} ${mobileOpen ? styles.hamburgerLineOpen2 : ""}`}
            />
            <span
              className={`${styles.hamburgerLine} ${mobileOpen ? styles.hamburgerLineOpen3 : ""}`}
            />
          </button>
        </div>
      </header>
