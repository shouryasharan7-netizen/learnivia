    ...
    <div>
      ...
      >
        <div>
          ...
          >
            Review applicant qualifications, verified academic report cards, and
            subject scores.
          </p>
        </div>
        <div
          ...
          {pendingTutors.map((tutor) => (
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    />
                    <strong
                      style={{ color: "var(--wa-ink)", fontSize: "0.95rem" }}
                    >
                  ...
                  {tutor.reportCardStorageKey || tutor.reportCardUrl ? (
                    ...
                    >
                      <CheckCircle2 size={12} aria-hidden="true" /> Document
                      Attached
                    </span>
                  ) : (
                    <span
                    ...
                    >
                      <AlertCircle size={12} aria-hidden="true" /> No Document
                      Uploaded
                    </span>
                  )}
                </div>
                ...
                <div style={{ fontSize: "0.9rem", color: "var(--wa-ink)" }}>
                  ...
                  {tutor.academicScores ? (
                    <span
                      style={{ color: "var(--wa-forest)", fontWeight: 700 }}
                    >
                      {tutor.academicScores}
                    </span>
                  ) : (
                    <span
                      style={{ color: "var(--wa-muted)", fontStyle: "italic" }}
                    >
                      Not provided yet
                    </span>
                  )}
                ...
                >
                  {tutor.reportCardStorageKey || tutor.reportCardUrl ? (
                    ...
                    >
                      <FileCheck size={16} aria-hidden="true" /> Open &amp;
                      Verify Report Card / Marksheet (
                      {tutor.reportCardName || "Document"}) ↗
                    </a>
                  ) : (
                    <div
                      style={{
                    ...
                    >
                      Applicant has not uploaded a report card document yet. You
                      can attach one below if received externally.
                    </div>
                  )}
                </div>
                ...
                <details style={{ marginTop: "0.5rem" }}>
                  ...
                  >
                    <Settings size={13} aria-hidden="true" /> Attach / Update
                    Report Card or Scores on behalf of applicant
                  </summary>
                  <form
              ...
              <div
                style={{
                  background:
                    tutor.trainingModules.length === 5 ? "#F0FDF4" : "#FFFBEB",
              ...
              >
                ...
                >
                  {[
                    ...
                    const completed = tutor.trainingModules.some(
                      (tm) => tm.moduleId === m.id && tm.quizPassed,
                    );
                    return (
                      <span
                        key={m.id}
                        ...
                        title={m.title}
                      >
                        {completed ? "Completed" : "Pending"}: M{m.id} (
                        {m.title})
                      </span>
                    );
                  })}
              ...
              >
                {tutor.trainingModules.length < 5 && (
                  ...
                  >
                    ...
                    <span>
                      <strong>Advisory:</strong> Applicant has completed{" "}
                      {tutor.trainingModules.length}/5 training modules. You may
                      approve if offline/direct orientation was provided.
                    </span>
                  </div>
                )}
