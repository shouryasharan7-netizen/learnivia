    ...
    <div>
      ...
      >
        <div>
          ...
          >
            Real-time stories and testimonials submitted by the community. Mock
      ...
      {stories.length === 0 ? (
        ...
        >
          ...
          >
            All mock and draft stories have been completely purged from the
            system. As authentic learners and tutors share real-time feedback,
        ...
        >
          {stories.map((story) => (
            ...
            >
              ...
              >
                <form
                  action={togglePublishStory.bind(
                    null,
                    story.id,
                    story.isPublished,
                  )}
