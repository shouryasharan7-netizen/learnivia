    ...
    >
      <div
        style={{
          ...
          padding: "2.5rem 2rem",
          textAlign: "center",
          boxShadow: "0 4px 20px rgba(30, 39, 34, 0.05)",
        }}
      >
        <div
          style={{
        ...
        >
          We encountered an issue loading your tutoring sessions. Please try
          refreshing or return to your student dashboard.
        </p>
        <div
          style={{
            display: "flex",
