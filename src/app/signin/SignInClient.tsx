...
const GoogleIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
    ...
    <path
      fill="#FBBC05"
      d="M3.964 10.707c-.18-.54-.282-1.117-.282-1.707s.102-1.167.282-1.707V4.961H.957A8.997 8.997 0 000 9c0 1.452.348 2.827.957 4.039l3.007-2.332z"
    />
    <path
      fill="#EA4335"
...
function SignInClientInner({ initialIsRegister = false }: SignInClientProps) {
  ...
  const [isRegister, setIsRegister] = useState(
    initialIsRegister || roleParam === "tutor",
  );
              ...
              <>
                ...
                {studentAge && parseInt(studentAge, 10) < 13 && (
                  <div>
                    <label
                      htmlFor="parentEmail"
                      style={{ ...labelStyle, color: "#0D9488" }}
                    >
                      Parent / Guardian Email{" "}
                      <span style={{ fontWeight: 400, color: "#64748B" }}>
                        (required for under 13)
                      </span>
                    </label>
                    <input
                      id="parentEmail"
