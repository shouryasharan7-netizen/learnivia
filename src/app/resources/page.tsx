...
export const metadata = {
  ...
  description:
    "Curated study guides, formula cheat sheets, and practice tools for students on Learnivia.",
};
...
const RESOURCE_SECTIONS = [
  {
    ...
    description:
      "Curated K-10 visual concept breakdowns, downloadable formula blueprints, and step-by-step problem guides across Math, Science, and English.",
  ...
  },
  {
    ...
    description:
      "Live focus timers, whiteboard scratchpads, equation reference guides, and collaborative practice prompts.",
  ...
  },
  {
    ...
    description:
      "Classroom safety guidelines, video session etiquette, and student protection protocols.",
    href: "/safety",
    icon: ShieldCheck,
    tag: "Safety & Trust",
  },
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Free study guides, formula cheat sheets, interactive practice tools,
            and learning strategies to help you succeed in your classes.
          </p>
        </div>
        ...
        <div className={styles.tipsSection} style={{ marginTop: "2.5rem" }}>
          ...
          >
            <div>
              <h2 className={styles.tipsHeading} style={{ margin: 0 }}>
                Core Academic Toolkits &amp; Cheat Sheets
              </h2>
              <p
                style={{
                  fontSize: "0.85rem",
              ...
              >
                Downloadable reference frameworks and formula sheets for high
                school and middle school courses.
              </p>
            </div>
            <Link
              href="/resources/study-guides"
