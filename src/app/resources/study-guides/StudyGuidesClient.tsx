...
export const STUDY_GUIDES: StudyGuide[] = [
  {
    ...
    summary:
      "Visual fact triangles, inverse relationships, distributive property, and long division algorithms.",
    keySnippet:
      "DMSB: Divide, Multiply, Subtract, Bring down • a × b = c ↔ c ÷ a = b",
    tags: ["Number Sense", "Multiplication", "Division", "Algorithms"],
    toolType: "fact-family",
    content: {
      overview:
        "A fact family is a group of related mathematical equations created using the same three numbers. Multiplication and division are inverse operations: they reverse and check each other.",
      coreRules: [
        {
          title: "Commutative Property",
          detail:
            "Order does not change the product: a × b = b × a (e.g. 7 × 8 = 8 × 7 = 56). Note: Division is NOT commutative (56 ÷ 8 ≠ 8 ÷ 56).",
        },
        {
          title: "Zero vs Identity Rule",
          detail:
            "a × 1 = a and a ÷ 1 = a. Any number times 0 equals 0 (a × 0 = 0). Crucial: Division by zero (a ÷ 0) is undefined.",
        },
        {
          title: "Long Division Algorithm (DMSB)",
          detail:
            "Remember 'Dad, Mom, Sister, Brother': 1. Divide, 2. Multiply, 3. Subtract, 4. Bring down the next digit.",
        },
      ],
      stepByStep: [
      ...
      workedExample: {
        problem:
          "Given factors 8 and 7, construct the complete fact family and check 56 ÷ 7.",
        steps: [
      ...
      practiceCheck: {
        question:
          "If 108 ÷ 12 = 9, what are the other three equations that belong to this fact family?",
        answer: "12 × 9 = 108, 9 × 12 = 108, and 108 ÷ 9 = 12.",
        explanation:
          "Because 12 and 9 are the factors that produce 108, reversing the multiplication and alternating the divisor completes the four equations.",
      },
    },
  },
  {
    ...
    summary:
      "Benchmark conversion tables, common denominators, and reciprocal division (Keep-Change-Flip).",
    keySnippet:
      "KCF: Keep, Change, Flip • 1/2 = 0.5 = 50% • 1/4 = 0.25 = 25% • 3/4 = 0.75 = 75%",
    tags: ["Fractions", "Decimals", "Percentages", "Equivalence"],
    toolType: "fraction-converter",
    content: {
      overview:
        "Fractions, decimals, and percentages are three distinct notations for describing parts of a whole. Fluency in switching between them is essential for ratio, rate, and algebraic problem solving.",
      coreRules: [
        {
          title: "Benchmark Equivalents",
          detail:
            "1/2 = 0.5 = 50% • 1/4 = 0.25 = 25% • 3/4 = 0.75 = 75% • 1/5 = 0.2 = 20% • 1/8 = 0.125 = 12.5% • 1/10 = 0.1 = 10% • 1/3 ≈ 0.333 = 33.3%.",
        },
        {
          title: "Adding & Subtracting Fractions",
          detail:
            "You MUST find a common denominator first: a/b + c/d = (ad + bc) / bd. Never add denominators straight across!",
        },
        {
          title: "Dividing Fractions (KCF)",
          detail:
            "Keep the first fraction, Change division (÷) to multiplication (×), Flip the second fraction into its reciprocal: (a/b) ÷ (c/d) = (a/b) × (d/c).",
        },
      ],
      stepByStep: [
      ...
      workedExample: {
        problem:
          "Calculate (3/4) ÷ (2/5) and express the result as an improper fraction and mixed number.",
        steps: [
      ...
      practiceCheck: {
        ...
        explanation:
          "7 ÷ 20 = 0.35. Multiplying 0.35 by 100 gives 35%. Alternatively, multiply numerator and denominator by 5: 35/100 = 35%.",
      },
    },
  },
  {
    ...
    gradeCategory: "middle",
    summary:
      "Systematic multi-step equation solving, balance principle, distributive property, and verification.",
    keySnippet:
      "Golden Rule: Whatever operation you perform on one side, you must mirror on the other.",
    tags: ["Algebra", "Linear Equations", "Variables", "Inverse Operations"],
    toolType: "none",
    content: {
      overview:
        "An algebraic equation represents a balanced scale. The goal is to isolate the target variable on one side by applying inverse mathematical operations in reverse order.",
      coreRules: [
        {
          title: "Order of Inverse Operations (SADMEP)",
          detail:
            "When isolating a variable, work in reverse order of PEMDAS: Subtract/Add first, then Divide/Multiply, then Exponents/Parentheses.",
        },
        {
          title: "Distributive Law",
          detail:
            "Multiply outer terms across all inner terms: a(bx + c) = abx + ac. Watch negative signs closely: -(x - 4) = -x + 4.",
        },
        {
          title: "Verification Step",
          detail:
            "Always substitute your calculated value of x back into the original unsimplified equation to verify both sides evaluate to equality.",
        },
      ],
      stepByStep: [
      ...
      practiceCheck: {
        ...
        answer: "x = 7",
        explanation:
          "5x - 2x - 8 = 13 → 3x - 8 = 13 → 3x = 21 → x = 7. Checking: 5(7) - 2(9) = 35 - 18 = 17.",
      },
    },
  },
  {
    ...
    gradeCategory: "high",
    summary:
      "Area, perimeter, surface area, cylinder/cone volume, and the Pythagorean Theorem.",
    keySnippet:
      "Right Triangles: a² + b² = c² • Circle: A = πr², C = 2πr • Cylinder: V = πr²h",
    tags: ["Geometry", "Area", "Perimeter", "Volume", "Pythagoras"],
    toolType: "none",
    content: {
      overview:
        "Geometry bridges spatial reasoning with algebraic formulas. Use this quick blueprint for 2D plane figures and 3D solid geometry.",
      coreRules: [
        {
          title: "2D Planar Formulas",
          detail:
            "Rectangle: A = l·w, P = 2(l+w) • Triangle: A = 1/2·b·h • Circle: A = πr², C = 2πr • Trapezoid: A = ((a+b)/2)·h.",
        },
        {
          title: "Pythagorean Theorem",
          detail:
            "In any right-angled triangle: a² + b² = c², where c is the hypotenuse opposite the 90° right angle. Common triples: (3,4,5), (5,12,13), (8,15,17).",
        },
        {
          title: "3D Solid Volumes",
          detail:
            "Rectangular Prism: V = l·w·h • Cylinder: V = πr²h • Cone: V = 1/3·πr²h • Sphere: V = 4/3·πr³.",
        },
      ],
      stepByStep: [
      ...
      workedExample: {
        problem:
          "A cylinder has a radius of 4 cm and a height of 10 cm. Find its volume in terms of π and to 2 decimal places.",
        steps: [
          "Formula: V = π·r²·h",
      ...
      practiceCheck: {
        question:
          "A right triangle has legs a = 6 cm and b = 8 cm. What is the length of the hypotenuse c?",
        answer: "c = 10 cm",
        explanation:
  ...
  },
  {
    ...
    gradeCategory: "elementary",
    summary:
      "Main idea vs topic, context clues (IDEAS), author's purpose (PIE), and inference formulation.",
    keySnippet:
      "Inference Formula: Text Clues + Prior Schema = Valid Logical Deduction",
    tags: [
      "Reading",
      "Comprehension",
      "Inference",
    ...
    content: {
      overview:
        "Active reading requires looking past surface words to decode authorial perspective, tone, and implied thematic significance.",
      coreRules: [
        {
          title: "The Inference Formula",
          detail:
            "Explicit Text Proof + Reader World Knowledge = Logical Inference. An inference must always be defended by textual evidence.",
        },
        {
          title: "Author's Purpose (P.I.E.)",
          detail:
            "Persuade (convince reader to act or think differently), Inform (teach facts objectively), Entertain (tell an engaging narrative).",
        },
        {
          title: "Context Clues (IDEAS Strategy)",
          detail:
            "Inference (clues in surrounding sentences), Definition (defined in text), Example (instances given), Antonym (contrasts with 'unlike', 'however'), Synonym (similar words).",
        },
      ],
      stepByStep: [
      ...
      workedExample: {
        problem:
          "Read sentence: 'Elena bundled her heavy wool scarf tighter as freezing gusts whipped the bare birch branches.' What can be inferred about the setting?",
        steps: [
      ...
      practiceCheck: {
        question:
          "What is the key difference between summarizing a text and analyzing a text?",
        answer:
          "A summary recounts WHAT happened; an analysis unpacks HOW and WHY the author crafted it.",
        explanation:
          "Summaries restate central events and facts. Analysis evaluates techniques, rhetorical strategies, and deeper thematic intent.",
      },
    },
  },
  {
    ...
    gradeCategory: "middle",
    summary:
      "Introductory thesis statements, body paragraph PEEL scaffold, and synthesis conclusions.",
    keySnippet:
      "P: Point • E: Evidence • E: Explanation (Analysis) • L: Link back to thesis",
    tags: ["Writing", "Essays", "PEEL", "Thesis", "Argumentation"],
    toolType: "peel-builder",
    content: {
      overview:
        "The PEEL framework provides a repeatable structure for analytical essays. It guarantees every body paragraph asserts a claim, backs it with proof, and analyzes significance.",
      coreRules: [
        {
          title: "P - Point (Topic Sentence)",
          detail:
            "Directly state the claim or argument of this paragraph. Must connect directly to one facet of your overarching thesis.",
        },
        {
          title: "E - Evidence (Cited Proof)",
          detail:
            "Provide specific textual evidence, historical data, or quoted lines. Always introduce the speaker or source context.",
        },
        {
          title: "E - Explanation (The Analytical Engine)",
          detail:
            "Explain HOW and WHY this evidence proves your point. Dedicate at least 2-3 sentences of original analytical thought per quote.",
        },
        {
          title: "L - Link (Thesis Bridge)",
          detail:
            "Summarize the significance and connect back to the primary essay thesis while setting up a transition to the next topic.",
        },
      ],
      stepByStep: [
      ...
      workedExample: {
        problem:
          "Exemplary PEEL paragraph analyzing Lord of the Flies conch shell.",
        steps: [
        ...
        result:
          "Complete, cohesive analytical paragraph with zero plot summary fluff.",
      },
      commonTraps: [
      ...
      practiceCheck: {
        question:
          "Why is the 'Explanation' component usually the longest part of a PEEL paragraph?",
        answer:
          "Because evidence cannot speak for itself; your original analysis proves why the quote matters.",
        explanation:
          "Without explanation, an essay is just a collection of quotes. The explanation provides your critical thinking and argument.",
      },
    },
  },
  {
    ...
    gradeCategory: "elementary",
    summary:
      "The rock cycle triad, hydrologic cycle phases, atmospheric layers, and weather front mechanics.",
    keySnippet:
      "Igneous (Melted) ↔ Sedimentary (Compacted) ↔ Metamorphic (Heated & Pressured)",
    tags: [
      "Earth Science",
      "Rock Cycle",
      "Water Cycle",
    ...
    content: {
      overview:
        "Earth is a dynamic closed system driven by geothermal heat from within and solar radiation from above. Matter continuously recycles through the geosphere, hydrosphere, and atmosphere.",
      coreRules: [
        {
          title: "The Three Rock Families",
          detail:
            "Igneous (cooled magma/lava like Granite, Basalt) • Sedimentary (compacted sediments with fossils like Sandstone, Limestone) • Metamorphic (heat & pressure altered like Marble, Slate).",
        },
        {
          title: "The Water Cycle (Hydrologic Cycle)",
          detail:
            "Evaporation (liquid to gas) + Transpiration (plant vapor) → Condensation (gas to cloud droplets) → Precipitation (rain/snow/sleet) → Collection/Runoff.",
        },
        {
          title: "Weather Fronts",
          detail:
            "Cold Fronts (dense cold air forces warm air up rapidly, creating thunderstorms) vs Warm Fronts (warm air slides gradually over cold air, bringing prolonged steady rain).",
        },
      ],
      stepByStep: [
      ...
      workedExample: {
        problem:
          "Trace how a volcanic granite rock can eventually become a metamorphic gneiss.",
        steps: [
        ...
        result:
          "Igneous → Sedimentary → Metamorphic progression through geological processes.",
      },
      commonTraps: [
      ...
      practiceCheck: {
        question:
          "In which category of rock are fossils exclusively preserved, and why?",
        answer: "Sedimentary rock.",
        explanation:
          "The extreme heat involved in creating igneous and metamorphic rocks melts or destroys organic remains.",
      },
    },
  },
  {
    ...
    gradeCategory: "middle",
    summary:
      "Cellular organelles, plant vs animal cells, photosynthesis equations, and trophic energy webs.",
    keySnippet:
      "Plant Only: Cell Wall, Chloroplast, Large Vacuole • Both: Nucleus, Mitochondria, Membrane",
    tags: ["Biology", "Cells", "Photosynthesis", "Respiration", "Ecosystems"],
    toolType: "none",
    content: {
      overview:
        "All living organisms are composed of cellular building blocks. Energy flows through biological systems via the reciprocal relationship between photosynthesis and cellular respiration.",
      coreRules: [
        {
          title: "Cell Organelle Functions",
          detail:
            "Nucleus (DNA control center) • Mitochondria (cellular respiration & ATP power) • Ribosomes (protein synthesis) • Cell Membrane (selective permeability boundary).",
        },
        {
          title: "Plant vs Animal Cell Key Differences",
          detail:
            "Plant Cells: possess rigid cellulose Cell Wall, Chloroplasts for light capture, and a Large Central Vacuole. Animal Cells: lack cell wall and chloroplasts; have small vacuoles.",
        },
        {
          title: "Photosynthesis vs Respiration",
          detail:
            "Photosynthesis: 6CO₂ + 6H₂O + light → C₆H₁₂O₆ + 6O₂. Respiration: C₆H₁₂O₆ + 6O₂ → 6CO₂ + 6H₂O + ATP energy.",
        },
      ],
      stepByStep: [
      ...
      workedExample: {
        problem:
          "In an ecosystem food web, a plant captures 10,000 Joules of solar energy. How much energy reaches the secondary consumer?",
        steps: [
        ...
        result:
          "100 Joules reaches the secondary consumer (90% lost as heat at each trophic transfer).",
      },
      commonTraps: [
      ...
      practiceCheck: {
        question:
          "What would happen to cellular energy production if an animal cell's mitochondria were damaged?",
        answer:
          "ATP energy production would drop drastically, starving the cell of metabolic power.",
        explanation:
          "Mitochondria produce over 90% of cellular ATP through aerobic respiration.",
      },
    },
  },
  {
    ...
    gradeCategory: "high",
    summary:
      "Subatomic particle charges, atomic vs mass number, electron shell octets, and bonding types.",
    keySnippet:
      "Atomic # = Protons • Mass # = Protons + Neutrons • Octet Rule = 8 Valence Electrons",
    tags: ["Chemistry", "Atoms", "Periodic Table", "Chemical Bonding"],
    toolType: "element-lookup",
    content: {
      overview:
        "Atoms are the fundamental building blocks of all chemical matter. Periodic trends predict an element's electron configuration, bonding behavior, and reactivity.",
      coreRules: [
        {
          title: "Subatomic Particle Charges",
          detail:
            "Protons: +1 charge, mass 1 amu (in nucleus; defines element Z) • Neutrons: 0 neutral charge, mass 1 amu (in nucleus) • Electrons: -1 charge, negligible mass (in orbitals).",
        },
        {
          title: "Reading Periodic Tiles",
          detail:
            "Atomic Number = number of protons = number of electrons in neutral atom. Mass Number = Protons + Neutrons. Neutrons = Mass Number - Atomic Number.",
        },
        {
          title: "Ionic vs Covalent Bonding",
          detail:
            "Ionic: Transfer of electrons between a metal and a nonmetal (e.g., Na⁺ + Cl⁻ → NaCl). Covalent: Sharing of electron pairs between nonmetals (e.g., H₂O, CO₂).",
        },
      ],
      stepByStep: [
      ...
      workedExample: {
        problem:
          "Analyze Sodium-23 (Na, Atomic Number 11). Determine its protons, neutrons, electrons, and valence electrons.",
        steps: [
        ...
        result:
          "11 Protons, 12 Neutrons, 11 Electrons, 1 Valence Electron (tends to form Na⁺ ion).",
      },
      commonTraps: [
      ...
      practiceCheck: {
        question:
          "How many protons, neutrons, and electrons are in a neutral Carbon-14 isotope atom? (Carbon atomic # = 6).",
        answer: "Protons = 6, Neutrons = 8, Electrons = 6.",
        explanation:
          "Atomic number 6 means 6 protons and 6 electrons. Mass number 14 minus 6 protons gives 8 neutrons.",
      },
    },
  },
  {
    ...
    gradeCategory: "high",
    summary:
      "Constant acceleration kinematics equations, Newton's 3 laws of motion, and work-energy theorem.",
    keySnippet:
      "v = v₀ + at • Δx = v₀t + 1/2at² • v² = v₀² + 2aΔx • F_net = ma • W = Fd",
    tags: ["Physics", "Kinematics", "Newton's Laws", "Forces", "Energy"],
    toolType: "none",
    content: {
      overview:
        "Classical mechanics describes how forces govern the motion of objects in space. Master the three kinematics formulas and Newton's laws to solve any 1D or 2D trajectory.",
      coreRules: [
        {
          title: "The 3 Big Kinematics Equations",
          detail:
            "1. v = v₀ + at (no Δx) • 2. Δx = v₀t + 1/2at² (no v) • 3. v² = v₀² + 2aΔx (no t).",
        },
        {
          title: "Newton's Three Laws",
          detail:
            "1st Law (Inertia): Objects preserve velocity unless acted on by net force. 2nd Law: F_net = m·a. 3rd Law: Forces occur in equal and opposite pairs on different objects (F_A on B = -F_B on A).",
        },
        {
          title: "Work & Kinetic Energy",
          detail:
            "Work = F · d · cos(θ) (Joules). Kinetic Energy KE = 1/2 m v². Gravitational Potential Energy PE = m·g·h (g ≈ 9.8 m/s²).",
        },
      ],
      stepByStep: [
      ...
      workedExample: {
        problem:
          "A skateboarder starts from rest (v₀ = 0) and accelerates uniformly down a ramp at 2.5 m/s² for 4 seconds. How far did they travel?",
        steps: [
      ...
      practiceCheck: {
        question:
          "A 5 kg crate is pushed with a net force of 35 N. What is its acceleration?",
        answer: "a = 7 m/s²",
  ...
  },
  {
    ...
    gradeCategory: "elementary",
    summary:
      "Latitude vs longitude, prime meridian, map legends, compass rose, and hemisphere divisions.",
    keySnippet:
      "Latitude = Flatitude (Equator 0°) • Longitude = Long vertical lines (Prime Meridian 0°)",
    tags: ["Geography", "Maps", "Latitude", "Longitude", "Hemispheres"],
    toolType: "none",
    content: {
      overview:
        "Geography provides spatial orientation to human history. Understanding coordinate systems, scales, and cartographic projections allows students to interpret historical trade, settlement, and climate patterns.",
      coreRules: [
        {
          title: "Latitude vs Longitude",
          detail:
            "Latitude: Horizontal lines measuring North/South of the Equator (0°). Remember 'Flatitude'. Longitude: Vertical meridians measuring East/West of the Prime Meridian (0°).",
        },
        {
          title: "Coordinates Format",
          detail:
            "Always written as (Latitude, Longitude), e.g., (40° N, 74° W for New York City). Latitude always comes first alphabetically.",
        },
        {
          title: "Map Essentials (DOGSTAILS)",
          detail:
            "Date, Orientation (Compass rose), Grid, Scale (distance ratio), Title, Author, Index, Legend (symbol key), Situation.",
        },
      ],
      stepByStep: [
      ...
      workedExample: {
        problem:
          "If a map scale indicates 1 inch = 75 miles, what is the actual ground distance between two cities 4 inches apart on the map?",
        steps: [
      ...
      practiceCheck: {
        question:
          "Which hemisphere contains both the entire continent of North America and South America?",
        answer: "The Western Hemisphere.",
        explanation:
          "Both American continents sit west of the Prime Meridian (0° longitude) in the Western Hemisphere.",
      },
    },
  },
];
...
export default function StudyGuidesClient() {
  ...
  const [activeGuideModal, setActiveGuideModal] = useState<StudyGuide | null>(
    null,
  );
  ...
  const filteredGuides = useMemo(() => {
    return STUDY_GUIDES.filter((guide) => {
      ...
      const matchesGrade =
        selectedGrade === "All" || guide.gradeCategory === selectedGrade;
      ...
      <div className={styles.container}>
        ...
        <div className={styles.heroSection}>
          ...
          <h1 className={styles.title}>
            K-10 Study Guides &amp; Subject Summaries
          </h1>
          <p className={styles.subtitle}>
            Comprehensive printable study guides, formula blueprints,
            step-by-step concept breakdowns, and interactive self-checks across
        ...
        <div className={styles.toolsBanner}>
          <div className={styles.toolsBannerLeft}>
            ...
            <div>
              <h3 className={styles.toolsBannerHeading}>
                Looking for live session utilities?
              </h3>
              <p className={styles.toolsBannerText}>
                Use the Focus Timer, Icebreaker Reflection Prompts, and live
                Session Scratchpad.
              </p>
            </div>
          </div>
          ...
          {filteredGuides.map((guide) => (
            <div key={guide.id} className={styles.guideCard}>
              ...
              <div className={styles.keySnippetBox}>
                <span className={styles.keySnippetLabel}>
                  Core Rule / Formula:
                </span>
                <code className={styles.keySnippetCode}>
                  {guide.keySnippet}
                </code>
              </div>
            ...
            <div className={styles.modalBody}>
              ...
              <section className={styles.guideSection}>
                ...
                <p className={styles.sectionParagraph}>
                  {activeGuideModal.content.overview}
                </p>
              </section>
              ...
              {activeGuideModal.toolType === "fact-family" && (
                <section className={styles.interactiveToolSection}>
                  <h3 className={styles.sectionHeading}>
                    <Calculator size={16} /> Interactive Fact Family Triangle
                    Generator
                  </h3>
                  <p className={styles.toolSubtext}>
                    Enter two factors to generate the complete four-equation
                    fact family.
                  </p>
                  ...
                  <div className={styles.calcResultsBox}>
                    <div className={styles.factTriangleHeader}>
                      Product: <strong>{ffFactorA * ffFactorB}</strong> (from{" "}
                      {ffFactorA} and {ffFactorB})
                    </div>
                    <div className={styles.factFamilyEquations}>
                      <div className={styles.factEquation}>
                        1. {ffFactorA} × {ffFactorB} = {ffFactorA * ffFactorB}
                      </div>
                      <div className={styles.factEquation}>
                        2. {ffFactorB} × {ffFactorA} = {ffFactorA * ffFactorB}
                      </div>
                      <div className={styles.factEquation}>
                        3. {ffFactorA * ffFactorB} ÷ {ffFactorA} = {ffFactorB}
                      </div>
                      <div className={styles.factEquation}>
                        4. {ffFactorA * ffFactorB} ÷ {ffFactorB} = {ffFactorA}
                      </div>
                    </div>
                  </div>
                </section>
              ...
              {activeGuideModal.toolType === "fraction-converter" && (
                <section className={styles.interactiveToolSection}>
                  <h3 className={styles.sectionHeading}>
                    <Calculator size={16} /> Live Fraction ↔ Decimal ↔
                  ...
                  <div className={styles.calcInputsRow}>
                    <div>
                      ...
                      <input
                        ...
                        value={fcNum}
                        onChange={(e) =>
                          setFcNum(Math.max(1, parseInt(e.target.value) || 1))
                        }
                        className={styles.calcInput}
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        value={fcDenom}
                        onChange={(e) =>
                          setFcDenom(Math.max(1, parseInt(e.target.value) || 1))
                        }
                        className={styles.calcInput}
                      />
                    </div>
              ...
              {activeGuideModal.toolType === "element-lookup" && (
                <section className={styles.interactiveToolSection}>
                  <h3 className={styles.sectionHeading}>
                    <Atom size={16} /> Quick Element &amp; Atomic Property
                    Lookup
                  </h3>
                  ...
                  <div className={styles.elementCard}>
                    <div className={styles.elementTile}>
                      <span className={styles.elementNum}>
                        {matchedElement.num}
                      </span>
                      <span className={styles.elementSym}>
                        {matchedElement.sym}
                      </span>
                      <span className={styles.elementName}>
                        {matchedElement.name}
                      </span>
                      <span className={styles.elementMass}>
                        {matchedElement.mass}
                      </span>
                    </div>
                    <div className={styles.elementDetails}>
                      <div className={styles.elementDetailRow}>
                        <span>Protons:</span>{" "}
                        <strong>{matchedElement.num}</strong>
                      </div>
                      <div className={styles.elementDetailRow}>
                        <span>Neutrons:</span>{" "}
                        <strong>
                          {Math.round(matchedElement.mass) - matchedElement.num}
                        </strong>
                      </div>
                      <div className={styles.elementDetailRow}>
                        <span>Electrons:</span>{" "}
                      ...
                      <div className={styles.elementDetailRow}>
                        ...
                        <strong>{matchedElement.val}</strong>
                      </div>
                      <div className={styles.elementDetailRow}>
                        <span>Classification:</span>{" "}
                        <strong>{matchedElement.group}</strong>
                      </div>
                    </div>
                  </div>
                </section>
              ...
              {activeGuideModal.toolType === "peel-builder" && (
                <section className={styles.interactiveToolSection}>
                  ...
                  <p className={styles.toolSubtext}>
                    Draft each layer of your argument and combine into an
                    analytical paragraph.
                  </p>
                  <div className={styles.peelInputs}>
                    <div>
                      <label className={styles.calcLabel}>
                        <strong>P</strong>oint (Topic Claim):
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className={styles.calcLabel}>
                        <strong>E</strong>vidence (Quoted Text with Context):
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className={styles.calcLabel}>
                        <strong>E</strong>xplanation (Word analysis and
                        meaning):
                      </label>
                      <textarea
                        rows={2}
                    ...
                    <div>
                      <label className={styles.calcLabel}>
                        <strong>L</strong>ink (Bridge back to thesis):
                      </label>
                      <input
                        type="text"
              ...
              <section className={styles.guideSection}>
                ...
                <div className={styles.workedExampleBox}>
                  <div className={styles.workedExampleProblem}>
                    ...
                    {activeGuideModal.content.workedExample.problem}
                  </div>
                  <div className={styles.workedStepsList}>
                    {activeGuideModal.content.workedExample.steps.map(
                      (step, idx) => (
                  ...
                  <div className={styles.workedResultRow}>
                    ...
                    <span>
                      ...
                      {activeGuideModal.content.workedExample.result}
                    </span>
                  </div>
                </div>
              </section>
              ...
              <section className={styles.guideSection}>
                ...
                <ul className={styles.trapsList}>
                  {activeGuideModal.content.commonTraps.map((trap, idx) => (
                    <li key={idx} className={styles.trapItem}>
                      {trap}
                    </li>
                  ))}
                </ul>
              ...
              <section className={styles.practiceSection}>
                ...
                <p className={styles.practiceQuestion}>
                  {activeGuideModal.content.practiceCheck.question}
                </p>
                {showPracticeAnswer && (
                  <div className={styles.practiceSolutionBox}>
                    <div className={styles.solutionAnswer}>
                      <strong>Answer:</strong>{" "}
                      {activeGuideModal.content.practiceCheck.answer}
                    </div>
