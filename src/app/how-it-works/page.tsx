...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Learnivia connects verified student tutors with K-10 learners for free 1-on-1 Zoom tutoring sessions.",
};
    ...
    <main className={styles.main}>
        ...
        <div className={styles.timelineContainer}>
          ...
          <div className={styles.timelineRow}>
            <div className={styles.timelineContent}>
              ...
              <p>
                ...
                bios and see subjects they love teaching.
              </p>
            </div>
          ...
          <div className={`${styles.timelineRow} ${styles.reverse}`}>
            <div className={styles.timelineContent}>
              ...
              <p>
                ...
                homework topic so your tutor can prepare.
              </p>
            </div>
            <div className={styles.timelineImage}>
              <div className={styles.imagePlaceholder}>
          ...
          <div className={styles.timelineRow}>
            <div className={styles.timelineContent}>
              ...
              <h3>Learn & Grow</h3>
              <p>
                Join a secure, private Zoom room. Work through problems together
                using screen sharing and whiteboards.
              </p>
            </div>
            <div className={styles.timelineImage}>
              <div className={styles.imagePlaceholder}>
        ...
        <div className={styles.timelineContainer}>
          ...
          <div className={`${styles.timelineRow} ${styles.reverse}`}>
            <div className={styles.timelineContent}>
              ...
              <h3>Get Certified</h3>
              <p>
                Pass our subject-knowledge tests and complete the mandatory
          ...
          <div className={`${styles.timelineRow} ${styles.reverse}`}>
            <div className={styles.timelineContent}>
              ...
              <p>
                After each successful session, receive verifiable volunteer hour
                certificates for college applications.
              </p>
            </div>
            <div className={styles.timelineImage}>
              <div className={styles.imagePlaceholder}>
      ...
      <section className={styles.stepsSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionLead}>
            Full oversight of your child's learning journey, private accounts,
          ...
          <div className={styles.timelineRow}>
            <div className={styles.timelineContent}>
              ...
              <p>
                ...
                below Grade 9. Sit in or supervise private Zoom sessions.
                Confirm attendance in one click to complete session records.
              </p>
            </div>
            <div className={styles.timelineImage}>
              <div className={styles.imagePlaceholder}>
