      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.subtitle}>
            Free, compassionate peer tutoring built for every K-10 learner, especially those who learn differently.
          </p>
        </div>
      </section>
      ...
      <section className={styles.contentSection}>
        <div className={styles.textBlock}>
          ...
          <p>
            ...
            deserves personalized, compassionate academic support, regardless of their income, learning style,
          ...
          <p style={{ marginTop: "0.75rem" }}>
            ...
            differently (those who needed more time, visual explanations, step-by-step pacing, or frequent
            breaks) were left without options. Learnivia was built to change that.
          </p>
        </div>
        ...
        <div className={styles.textBlock}>
          <h2>Our Mission</h2>
          <p>
            Learnivia connects verified volunteer tutors with K-10 students for free, private 1-on-1 Zoom sessions.
            We are built on the belief that peer learning, when done with care and structure, can be transformative.
          </p>
          <p style={{ marginTop: "0.75rem" }}>
            We are specifically designed to welcome students who learn differently: visual learners,
        ...
        <div className={styles.textBlock}>
          ...
          <ul className={styles.featureList}>
            <li className={styles.featureItem}>
              ...
              <span>Parents select their child&apos;s grade (K-10) and subject</span>
            </li>
            <li className={styles.featureItem}>
              <CheckCircle2 size={18} style={{ color: "var(--wa-forest)", flexShrink: 0 }} aria-hidden="true" />
            ...
            <li className={styles.featureItem}>
              <CheckCircle2 size={18} style={{ color: "var(--wa-forest)", flexShrink: 0 }} aria-hidden="true" />
              <span>Sessions are logged for volunteer-hour verification, no recording without consent</span>
            </li>
            <li className={styles.featureItem}>
              <CheckCircle2 size={18} style={{ color: "var(--wa-forest)", flexShrink: 0 }} aria-hidden="true" />
        ...
        <div className={styles.textBlock}>
          ...
          <p style={{ marginTop: "0.75rem" }}>
            ...
            Record with unique session verification IDs, suitable for school counselors, advisors,
        ...
        <div className={styles.ctaBox}>
          ...
          <p>Whether you need help or want to give back, there&apos;s a place for you here, always free.</p>
          <div className={styles.btnGroup}>
            <Link href="/signup" className={styles.primaryBtn}>Find a Free Tutor</Link>
