...
export function NextActionPanel({
  ...
  if (guardianConsentPending) {
    return (
      <aside
        className={`${styles.nextActionPanel} ${styles.nextActionWarning}`}
        aria-label="Action required"
      >
        <div className={styles.nextActionContent}>
          <div
            className={`${styles.nextActionIcon} ${styles.nextActionIconWarning}`}
          >
            <AlertCircle size={20} />
          </div>
          <div className={styles.nextActionBody}>
            <h2 className={styles.nextActionTitle}>
              Guardian consent invitation pending
            </h2>
            <p className={styles.nextActionDesc}>
              Under Learnivia child safeguarding policies, minor learners
              require guardian confirmation before scheduling 1-on-1 tutoring
              sessions.
            </p>
          </div>
        </div>
  ...
  if (isNewLearner) {
    return (
      <aside
        className={styles.nextActionPanel}
      ...
      >
        <div className={styles.nextActionContent}>
          ...
          <div className={styles.nextActionBody}>
            ...
            <p className={styles.nextActionDesc}>
              Tell us your grade level and preferred learning topics so our
              volunteer tutors can prepare personalized materials for your
              sessions.
            </p>
          </div>
        </div>
  ...
  if (hasUpcomingSession && nextSession) {
    return (
      <aside
        className={styles.nextActionPanel}
        aria-label="Upcoming tutoring session"
      >
        <div className={styles.nextActionContent}>
          <div className={styles.nextActionIcon}>
            <Video size={20} />
          ...
          <div className={styles.nextActionBody}>
            ...
            <p className={styles.nextActionDesc}>
              Your session is confirmed. Review your questions and join the
              verified Zoom waiting room a few minutes before start time.
            </p>
          </div>
        </div>
  ...
  if (isTrainingPending) {
    return (
      <aside
        className={styles.nextActionPanel}
        aria-label="Tutor training required"
      >
        <div className={styles.nextActionContent}>
          <div
            className={styles.nextActionIcon}
            style={{
          ...
          <div className={styles.nextActionBody}>
            ...
            <p className={styles.nextActionDesc}>
              Your volunteer tutor application is approved! Complete all 5 short
              modules to unlock session hosting and your full Tutor Workspace.
            </p>
          </div>
        </div>
  ...
  if (isPendingTutor) {
    return (
      <aside
        className={styles.nextActionPanel}
        aria-label="Tutor application status"
      >
        <div className={styles.nextActionContent}>
          <div
            className={styles.nextActionIcon}
  ...
  if (isApprovedTutor) {
    return (
      <aside
        className={styles.nextActionPanel}
        aria-label="Volunteer tutor status"
      >
        <div className={styles.nextActionContent}>
          <div className={styles.nextActionIcon}>
            <ShieldCheck size={20} />
          ...
          <div className={styles.nextActionBody}>
            <h2 className={styles.nextActionTitle}>
              Your volunteer tutor profile is active
            </h2>
            <p className={styles.nextActionDesc}>
              Open your Tutor Workspace to update your weekly availability, host
              small-group workshops, and track verified service hours.
            </p>
          </div>
        </div>
  ...
  if (hasCompletedSession && lastCompletedSession) {
    return (
      <aside
        className={styles.nextActionPanel}
        aria-label="Recent session completed"
      >
        <div className={styles.nextActionContent}>
          <div className={styles.nextActionIcon}>
          ...
          <div className={styles.nextActionBody}>
            ...
            <p className={styles.nextActionDesc}>
              You finished your peer session with{" "}
              {lastCompletedSession.tutorName}. Schedule your next 1-on-1
              check-in or submit a question to homework help.
            </p>
          </div>
        </div>
  ...
  return (
    <aside
      className={styles.nextActionPanel}
      aria-label="Get started with peer tutoring"
    >
      <div className={styles.nextActionContent}>
        <div className={styles.nextActionIcon}>
          <Compass size={20} />
        ...
        <div className={styles.nextActionBody}>
          <h2 className={styles.nextActionTitle}>
            Find a verified volunteer tutor
          </h2>
          <p className={styles.nextActionDesc}>
            Connect 1-on-1 with student tutors across Mathematics, Sciences, and
            Humanities for free homework reviews and exam prep.
          </p>
        </div>
      </div>
      <Link href={ROUTES.find} className={styles.nextActionBtn}>
